...
class DictionaryArchitectureTest {

    private final JavaClasses classes = new ClassFileImporter()
            .withImportOption(new ImportOption.DoNotIncludeTests())
            .importPackages("dev.ainer.module.dictionary.dictionary");
    ...
    void domainDependsOnlyOnItselfAndJava() {
        noClasses()
                ...
                .should().dependOnClassesThat().resideOutsideOfPackages(
                        "java..",
                        "org.jspecify..",
                        "dev.ainer.module.dictionary.dictionary.domain..")
                .check(classes);
    }
    ...
    void featureLayersAreFreeOfCycles() {
        slices()
                .matching("dev.ainer.module.dictionary.dictionary.(*)..")

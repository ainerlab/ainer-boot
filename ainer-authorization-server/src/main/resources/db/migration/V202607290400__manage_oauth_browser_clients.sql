-- Browser/OIDC client lifecycle table (parallel to ainer_oauth_service_client).
-- Public PKCE clients (Authorization Code, no secret) managed by a dedicated operator.

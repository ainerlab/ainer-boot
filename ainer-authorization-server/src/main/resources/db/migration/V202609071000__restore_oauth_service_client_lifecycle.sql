-- Restore OAuth service client lifecycle tables omitted from the
-- V202608070330 foundation baseline (regression of the V202607231000 /
-- V202607231010 squash, ADR-0013). ManagedRegisteredClientRepository reads
-- ainer_oauth_service_client at startup, so a fresh database could not boot

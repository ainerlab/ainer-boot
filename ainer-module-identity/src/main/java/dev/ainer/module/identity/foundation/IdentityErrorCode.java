...
public enum IdentityErrorCode implements ErrorCode {
    ...
    HUMAN_ACCOUNT_STATE_CONFLICT(
            "AINER.IDENTITY.HUMAN_ACCOUNT_STATE_CONFLICT", "人类安全账号状态不允许该变更", 409),
    ...
    SERVICE_PRINCIPAL_STATE_CONFLICT(
            "AINER.IDENTITY.SERVICE_PRINCIPAL_STATE_CONFLICT", "服务主体状态不允许该变更", 409),

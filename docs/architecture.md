...
> 权威状态：`v1.4.1` 是当前稳定版本；`v1.0.0` 为升级起点与 `1.0.x` LTS；运行基线 Spring Boot 4.1.1；`v1.1.0` withdrawn · 核对 2026-08-28
...
`v1.4.0` 进一步为已有单模块 Maven/Spring Boot 项目提供 `plan-add` / `add`：调用者显式给出

...
| [0056](0056-identity-lifecycle-write-path-and-security-epoch.md) | Accepted | 账号/服务主体生命周期写路径、`security_epoch` 条件 UPDATE 递增语义与"即时撤销只成立于在线校验"边界（细化 ADR-0033，保持 ADR-0011） |

...
class AgentDelegationFlowTest {
    ...
    void cleanSeedAndAuthenticate() {
        ...
        seedPermission("agentflow.resource.write", true, "MEDIUM");
        seedPermission("agentflow.nondelegable.write", false, "MEDIUM");
    ...
    private void seedPermission(String code, boolean delegable, String riskTier) {
        jdbcTemplate.update("""
                ...
                VALUES (?, 'write', 'agentflow.resource', ?, 'ON_DECISION', false, ?,
                        'agentflow-test', 1, now(), now())
                """, code, riskTier, delegable);
    }
